...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Funkin 64", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Funkin 64", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "thewhiteninja";
		app.meta["file"] = "Funkin 64";
		app.meta["name"] = "Funkin 64";
		app.meta["packageName"] = "com.thewhiteninja.funkin64";
