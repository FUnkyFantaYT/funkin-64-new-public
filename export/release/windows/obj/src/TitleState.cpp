...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_386_getIntroTextShit,"TitleState","getIntroTextShit",0x5dcf15b8,"TitleState.getIntroTextShit","TitleState.hx",386,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_404_update,"TitleState","update",0x8b12e05e,"TitleState.update","TitleState.hx",404,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_449_update,"TitleState","update",0x8b12e05e,"TitleState.update","TitleState.hx",449,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_523_createCoolText,"TitleState","createCoolText",0x83610287,"TitleState.createCoolText","TitleState.hx",523,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_537_addMoreText,"TitleState","addMoreText",0xcf420fae,"TitleState.addMoreText","TitleState.hx",537,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_548_deleteCoolText,"TitleState","deleteCoolText",0x8afda2b6,"TitleState.deleteCoolText","TitleState.hx",548,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_558_beatHit,"TitleState","beatHit",0xfba69a88,"TitleState.beatHit","TitleState.hx",558,0xd132a6e5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_681_skipIntro,"TitleState","skipIntro",0xc9924038,"TitleState.skipIntro","TitleState.hx",681,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_693_skipIntro,"TitleState","skipIntro",0xc9924038,"TitleState.skipIntro","TitleState.hx",693,0xd132a6e5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_401_boot,"TitleState","boot",0x7c582f47,"TitleState.boot","TitleState.hx",401,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_556_boot,"TitleState","boot",0x7c582f47,"TitleState.boot","TitleState.hx",556,0xd132a6e5)
...
HXLINE( 642)		this->increaseVolume = false;
HXLINE( 641)		this->skippedIntro = false;
HXLINE( 555)		this->sickBeats = 0;
HXLINE( 400)		this->transitioning = false;
...
HXDLIN( 271)		 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(HX_("logoBumpin",26,cb,02,ab),null());
HXDLIN( 271)		bool xmlExists = false;
HXDLIN( 271)		if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("logoBumpin",26,cb,02,ab)) + HX_(".xml",69,3e,c3,1e))))) {
...
HXLINE( 271)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("logoBumpin",26,cb,02,ab),library);
HXDLIN( 271)			_hx_tmp3 = returnAsset;
            		}
HXDLIN( 271)		::String _hx_tmp4;
HXDLIN( 271)		if (xmlExists) {
HXLINE( 271)			_hx_tmp4 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("logoBumpin",26,cb,02,ab)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE( 271)			_hx_tmp4 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("logoBumpin",26,cb,02,ab)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
...
HXLINE( 305)			{
HXLINE( 309)				 ::flixel::FlxSprite _hx_tmp5 = this->gfDance;
HXDLIN( 309)				::String library1 = null();
HXDLIN( 309)				 ::flixel::graphics::FlxGraphic imageLoaded1 = ::Paths_obj::returnGraphic(HX_("gfDanceTitle",64,64,d2,7b),null());
HXDLIN( 309)				bool xmlExists1 = false;
HXDLIN( 309)				if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("gfDanceTitle",64,64,d2,7b)) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 309)					xmlExists1 = true;
            				}
HXDLIN( 309)				 ::Dynamic _hx_tmp6;
HXDLIN( 309)				if (::hx::IsNotNull( imageLoaded1 )) {
HXLINE( 309)					_hx_tmp6 = imageLoaded1;
            				}
            				else {
HXLINE( 309)					 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("gfDanceTitle",64,64,d2,7b),library1);
HXDLIN( 309)					_hx_tmp6 = returnAsset;
            				}
HXDLIN( 309)				::String _hx_tmp7;
HXDLIN( 309)				if (xmlExists1) {
HXLINE( 309)					_hx_tmp7 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("gfDanceTitle",64,64,d2,7b)) + HX_(".xml",69,3e,c3,1e))));
            				}
            				else {
HXLINE( 309)					_hx_tmp7 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("gfDanceTitle",64,64,d2,7b)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1);
            				}
HXDLIN( 309)				_hx_tmp5->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp6,_hx_tmp7));
HXLINE( 310)				this->gfDance->animation->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_6,16),HX_("",00,00,00,00),24,false,null(),null());
HXLINE( 311)				this->gfDance->animation->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_7,15),HX_("",00,00,00,00),24,false,null(),null());
            			}
            		}
HXLINE( 313)		this->gfDance->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 315)		this->add(this->gfDance);
HXLINE( 316)		this->gfDance->shader = this->swagShader->shader;
HXLINE( 317)		this->add(this->logoBl);
HXLINE( 318)		this->logoBl->shader = this->swagShader->shader;
HXLINE( 320)		this->titleText =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,this->titleJSON->__Field(HX_("startx",d6,61,fa,05),::hx::paccDynamic),this->titleJSON->__Field(HX_("starty",d7,61,fa,05),::hx::paccDynamic),null());
HXLINE( 322)		::String path = ((HX_("mods/",9e,2f,58,0c) + ::Paths_obj::currentModDirectory) + HX_("/images/titleEnter.png",c3,97,17,95));
HXLINE( 324)		if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE( 325)			path = HX_("mods/images/titleEnter.png",f4,47,59,97);
            		}
HXLINE( 328)		if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE( 329)			path = HX_("assets/images/titleEnter.png",86,9a,cd,1d);
            		}
HXLINE( 332)		 ::flixel::FlxSprite _hx_tmp8 = this->titleText;
HXDLIN( 332)		 ::openfl::display::BitmapData _hx_tmp9 = ::openfl::display::BitmapData_obj::fromFile(path);
HXDLIN( 332)		_hx_tmp8->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp9,::sys::io::File_obj::getContent(::StringTools_obj::replace(path,HX_(".png",3b,2d,bd,1e),HX_(".xml",69,3e,c3,1e)))));
HXLINE( 337)		this->titleText->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Press Enter to Begin",e9,79,2c,83),24,null(),null(),null());
HXLINE( 338)		this->titleText->animation->addByPrefix(HX_("press",83,53,88,c8),HX_("ENTER PRESSED",5a,47,9f,63),24,null(),null(),null());
HXLINE( 339)		this->titleText->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 340)		this->titleText->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 341)		this->titleText->updateHitbox();
HXLINE( 343)		this->add(this->titleText);
HXLINE( 345)		 ::flixel::FlxSprite logo =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXDLIN( 345)		::String library2 = null();
HXDLIN( 345)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("logo",6b,9f,b7,47),library2);
HXDLIN( 345)		 ::flixel::FlxSprite logo1 = logo->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE( 346)		logo1->screenCenter(null());
HXLINE( 347)		logo1->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 353)		this->credGroup =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE( 354)		this->add(this->credGroup);
HXLINE( 355)		this->textGroup =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE( 357)		this->blackScreen =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,-16777216,null(),null());
HXLINE( 358)		this->credGroup->add(this->blackScreen).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 360)		this->credTextShit =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("",00,00,00,00),true,null(),null(),null());
HXLINE( 361)		this->credTextShit->screenCenter(null());
HXLINE( 365)		this->credTextShit->set_visible(false);
HXLINE( 367)		 ::flixel::FlxSprite _hx_tmp10 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.52)),null());
HXDLIN( 367)		::String library3 = null();
HXDLIN( 367)		 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(HX_("newgrounds_logo",1e,5c,8d,a6),library3);
HXDLIN( 367)		this->ngSpr = _hx_tmp10->loadGraphic(returnAsset1,null(),null(),null(),null(),null());
HXLINE( 368)		this->add(this->ngSpr);
HXLINE( 369)		this->ngSpr->set_visible(false);
HXLINE( 370)		 ::flixel::FlxSprite _hx_tmp11 = this->ngSpr;
HXDLIN( 370)		_hx_tmp11->setGraphicSize(::Std_obj::_hx_int((this->ngSpr->get_width() * ((Float)0.8))),null());
HXLINE( 371)		this->ngSpr->updateHitbox();
HXLINE( 372)		this->ngSpr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 373)		this->ngSpr->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 375)		::flixel::tweens::FlxTween_obj::tween(this->credTextShit, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 377)		if (::TitleState_obj::initialized) {
HXLINE( 378)			this->skipIntro();
            		}
            		else {
HXLINE( 380)			::TitleState_obj::initialized = true;
            		}
            	}
...
::Array< ::Dynamic> TitleState_obj::getIntroTextShit(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_386_getIntroTextShit)
HXLINE( 387)		::String library = null();
HXDLIN( 387)		::String fullText = ::openfl::utils::Assets_obj::getText(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("introText",39,69,67,a6)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 389)		::Array< ::String > firstArray = fullText.split(HX_("\n",0a,00,00,00));
HXLINE( 390)		::Array< ::Dynamic> swagGoodArray = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 392)		{
HXLINE( 392)			int _g = 0;
HXDLIN( 392)			while((_g < firstArray->length)){
HXLINE( 392)				::String i = firstArray->__get(_g);
HXDLIN( 392)				_g = (_g + 1);
HXLINE( 394)				swagGoodArray->push(i.split(HX_("--",60,27,00,00)));
            			}
            		}
HXLINE( 397)		return swagGoodArray;
            	}
...
void TitleState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_404_update)
HXDLIN( 404)		 ::TitleState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 405)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music )) {
HXLINE( 406)			::Conductor_obj::songPosition = ::flixel::FlxG_obj::sound->music->_time;
            		}
HXLINE( 409)		bool pressedEnter;
HXDLIN( 409)		 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 409)		if (!(_this->keyManager->checkStatus(13,_this->status))) {
HXLINE( 409)			pressedEnter = ::PlayerSettings_obj::player1->controls->_accept->check();
            		}
            		else {
...
HXLINE( 425)			 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this = gamepad->justPressed;
HXDLIN( 425)			int id = 7;
HXDLIN( 425)			 ::flixel::input::gamepad::FlxGamepad _this1 = _this->gamepad;
HXDLIN( 425)			int Status = _this->status;
HXDLIN( 425)			bool _hx_tmp;
HXDLIN( 425)			switch((int)(id)){
            				case (int)-2: {
HXLINE( 425)					_hx_tmp = _this1->anyButton(Status);
            				}
            				break;
            				case (int)-1: {
HXLINE( 425)					_hx_tmp = !(_this1->anyButton(Status));
            				...
            				break;
            				default:{
HXLINE( 425)					int RawID = _this1->mapping->getRawID(id);
HXDLIN( 425)					 ::flixel::input::gamepad::FlxGamepadButton button = _this1->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 425)					if (::hx::IsNotNull( button )) {
HXLINE( 425)						_hx_tmp = button->hasState(Status);
            					}
            					else {
...
HXDLIN( 436)		if (::TitleState_obj::initialized) {
HXLINE( 436)			_hx_tmp1 = !(this->transitioning);
            		}
            		else {
HXLINE( 436)			_hx_tmp1 = false;
            		}
HXDLIN( 436)		if (_hx_tmp1) {
HXLINE( 436)			_hx_tmp = this->skippedIntro;
            		}
            		else {
...
HXLINE( 438)			if (pressedEnter) {
            				...
            				void _hx_run( ::flixel::util::FlxTimer tmr){
            					HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_449_update)
HXLINE( 450)					if (_gthis->mustUpdate) {
HXLINE( 451)						::MusicBeatState_obj::switchState( ::OutdatedState_obj::__alloc( HX_CTX ,null(),null()));
            					}
            					else {
HXLINE( 453)						::MusicBeatState_obj::switchState( ::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
            					}
HXLINE( 455)					::TitleState_obj::closedState = true;
            				}
            				HX_END_LOCAL_FUNC1((void))

HXLINE( 440)				if (::hx::IsNotNull( this->titleText )) {
HXLINE( 440)					this->titleText->animation->play(HX_("press",83,53,88,c8),null(),null(),null());
            				}
HXLINE( 442)				::flixel::FlxG_obj::camera->flash(-1,1,null(),null());
HXLINE( 443)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 443)				_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),((Float)0.7),null(),null(),null(),null());
HXLINE( 445)				this->transitioning = true;
HXLINE( 448)				 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(1, ::Dynamic(new _hx_Closure_0(_gthis)),null());
            			}
            		}
HXLINE( 507)		bool _hx_tmp2;
HXDLIN( 507)		bool _hx_tmp3;
HXDLIN( 507)		if (::TitleState_obj::initialized) {
...
HXLINE( 514)			if (::PlayerSettings_obj::player1->controls->_ui_left->check()) {
HXLINE( 514)				 ::ColorSwap fh = this->swagShader;
HXDLIN( 514)				fh->set_hue((fh->hue - (elapsed * ((Float)0.1))));
            			}
HXLINE( 515)			if (::PlayerSettings_obj::player1->controls->_ui_right->check()) {
HXLINE( 515)				 ::ColorSwap fh = this->swagShader;
...
void TitleState_obj::createCoolText(::Array< ::String > textArray, ::Dynamic __o_offset){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_523_createCoolText)
HXDLIN( 523)		int _g = 0;
HXDLIN( 523)		int _g1 = textArray->length;
HXDLIN( 523)		while((_g < _g1)){
HXDLIN( 523)			_g = (_g + 1);
HXDLIN( 523)			int i = (_g - 1);
HXLINE( 525)			 ::Alphabet money =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),textArray->__get(i),true,false,null(),null());
HXLINE( 526)			money->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 527)			money->set_y((money->y + (((i * 60) + 200) + offset)));
HXLINE( 528)			bool _hx_tmp;
HXDLIN( 528)			if (::hx::IsNotNull( this->credGroup )) {
HXLINE( 528)				_hx_tmp = ::hx::IsNotNull( this->textGroup );
            			}
            			else {
...
void TitleState_obj::addMoreText(::String text, ::Dynamic __o_offset){
            		 ::Dynamic offset = __o_offset;
            		if (::hx::IsNull(__o_offset)) offset = 0;
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_537_addMoreText)
...
HXLINE( 538)			 ::Alphabet coolText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),text,true,false,null(),null());
HXLINE( 539)			coolText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
...
void TitleState_obj::deleteCoolText(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_548_deleteCoolText)
...
void TitleState_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_558_beatHit)
...
HXLINE( 574)			switch((int)(this->sickBeats)){
            				case (int)1: {
HXLINE( 578)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_18,1),15);
            				}
            				break;
            				case (int)3: {
HXLINE( 585)					this->addMoreText(HX_("Shadow Mario",c4,01,05,71),15);
HXLINE( 586)					this->addMoreText(HX_("RiverOaken",36,1d,dd,33),15);
HXLINE( 587)					this->addMoreText(HX_("shubs",11,04,2c,7c),15);
            				}
            				break;
            				case (int)4: {
HXLINE( 594)					this->deleteCoolText();
            				...
            				break;
            				case (int)5: {
HXLINE( 600)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_19,2),-40);
            				}
            				break;
            				case (int)7: {
...
void TitleState_obj::skipIntro(){
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_644_skipIntro)
HXDLIN( 644)		 ::TitleState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 645)		if (!(this->skippedIntro)) {
HXLINE( 647)			if (::TitleState_obj::playJingle) {
HXLINE( 649)				::String easteregg = ( (::String)(::flixel::FlxG_obj::save->data->__Field(HX_("psychDevsEasterEgg",22,2b,1d,02),::hx::paccDynamic)) );
HXLINE( 650)				if (::hx::IsNull( easteregg )) {
HXLINE( 650)					easteregg = HX_("",00,00,00,00);
            				}
HXLINE( 651)				easteregg = easteregg.toUpperCase();
HXLINE( 653)				 ::flixel::_hx_system::FlxSound sound = null();
HXLINE( 654)				::String _hx_switch_0 = easteregg;
            				if (  (_hx_switch_0==HX_("BBPANZU",78,33,57,57)) ){
HXLINE( 663)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd sound1 = ::flixel::FlxG_obj::sound;
HXDLIN( 663)					sound = sound1->play(::Paths_obj::sound(HX_("JingleBB",51,0b,1a,28),null()),null(),null(),null(),null(),null());
HXDLIN( 663)					goto _hx_goto_20;
            				}
            				if (  (_hx_switch_0==HX_("RIVER",ec,a2,5d,67)) ){
HXLINE( 657)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd sound1 = ::flixel::FlxG_obj::sound;
HXDLIN( 657)					sound = sound1->play(::Paths_obj::sound(HX_("JingleRiver",fb,99,93,2f),null()),null(),null(),null(),null(),null());
HXDLIN( 657)					goto _hx_goto_20;
            				}
            				if (  (_hx_switch_0==HX_("SHADOW",e0,73,a3,cf)) ){
HXLINE( 661)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 661)					_hx_tmp->play(::Paths_obj::sound(HX_("JingleShadow",11,aa,a5,36),null()),null(),null(),null(),null(),null());
HXDLIN( 661)					goto _hx_goto_20;
            				}
            				if (  (_hx_switch_0==HX_("SHUBS",f1,3b,1a,fa)) ){
HXLINE( 659)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd sound1 = ::flixel::FlxG_obj::sound;
HXDLIN( 659)					sound = sound1->play(::Paths_obj::sound(HX_("JingleShubs",00,33,50,c2),null()),null(),null(),null(),null(),null());
HXDLIN( 659)					goto _hx_goto_20;
            				}
            				/* default */{
HXLINE( 666)					this->remove(this->ngSpr,null());
HXLINE( 667)					this->remove(this->credGroup,null());
HXLINE( 668)					::flixel::FlxG_obj::camera->flash(-1,2,null(),null());
HXLINE( 669)					this->skippedIntro = true;
HXLINE( 670)					::TitleState_obj::playJingle = false;
HXLINE( 672)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 672)					::String library = null();
HXDLIN( 672)					 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),HX_("freakyMenu",15,c9,93,86),library);
HXDLIN( 672)					_hx_tmp->playMusic(file,0,null(),null());
HXLINE( 673)					{
HXLINE( 673)						 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 673)						 ::Dynamic onComplete = null();
HXDLIN( 673)						if (::hx::IsNull( _this->_channel )) {
HXLINE( 673)							_this->play(null(),null(),null());
            						}
HXDLIN( 673)						if (::hx::IsNotNull( _this->fadeTween )) {
HXLINE( 673)							_this->fadeTween->cancel();
            						}
HXDLIN( 673)						_this->fadeTween = ::flixel::tweens::FlxTween_obj::num(( (Float)(0) ),((Float)0.7),4, ::Dynamic(::hx::Anon_obj::Create(1)
            							->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete)),_this->volumeTween_dyn());
            					}
HXLINE( 674)					return;
            				}
            				_hx_goto_20:;
HXLINE( 677)				this->transitioning = true;
HXLINE( 678)				if ((easteregg == HX_("SHADOW",e0,73,a3,cf))) {
            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::TitleState,_gthis) HXARGC(1)
            					void _hx_run( ::flixel::util::FlxTimer tmr){
            						HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_681_skipIntro)
HXLINE( 682)						_gthis->remove(_gthis->ngSpr,null()).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 683)						_gthis->remove(_gthis->credGroup,null()).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 684)						::flixel::FlxG_obj::camera->flash(-1,((Float)0.6),null(),null());
HXLINE( 685)						_gthis->transitioning = false;
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 680)					 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)3.2), ::Dynamic(new _hx_Closure_0(_gthis)),null());
            				}
            				else {
            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_1, ::TitleState,_gthis) HXARGC(0)
            					void _hx_run(){
            						HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_693_skipIntro)
HXLINE( 694)						 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 694)						::String library = null();
HXDLIN( 694)						 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),HX_("freakyMenu",15,c9,93,86),library);
HXDLIN( 694)						_hx_tmp->playMusic(file,0,null(),null());
HXLINE( 695)						{
HXLINE( 695)							 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 695)							 ::Dynamic onComplete = null();
HXDLIN( 695)							if (::hx::IsNull( _this->_channel )) {
HXLINE( 695)								_this->play(null(),null(),null());
            							}
HXDLIN( 695)							if (::hx::IsNotNull( _this->fadeTween )) {
HXLINE( 695)								_this->fadeTween->cancel();
            							}
HXDLIN( 695)							_this->fadeTween = ::flixel::tweens::FlxTween_obj::num(( (Float)(0) ),((Float)0.7),4, ::Dynamic(::hx::Anon_obj::Create(1)
            								->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete)),_this->volumeTween_dyn());
            						}
HXLINE( 696)						_gthis->transitioning = false;
            					}
            					HX_END_LOCAL_FUNC0((void))

HXLINE( 690)					this->remove(this->ngSpr,null());
HXLINE( 691)					this->remove(this->credGroup,null());
HXLINE( 692)					::flixel::FlxG_obj::camera->flash(-1,3,null(),null());
HXLINE( 693)					sound->onComplete =  ::Dynamic(new _hx_Closure_1(_gthis));
            				}
HXLINE( 699)				::TitleState_obj::playJingle = false;
            			}
            			else {
HXLINE( 703)				this->remove(this->ngSpr,null());
HXLINE( 704)				this->remove(this->credGroup,null());
HXLINE( 705)				::flixel::FlxG_obj::camera->flash(-1,4,null(),null());
HXLINE( 707)				::String easteregg = ( (::String)(::flixel::FlxG_obj::save->data->__Field(HX_("psychDevsEasterEgg",22,2b,1d,02),::hx::paccDynamic)) );
HXLINE( 708)				if (::hx::IsNull( easteregg )) {
HXLINE( 708)					easteregg = HX_("",00,00,00,00);
            				}
HXLINE( 709)				easteregg = easteregg.toUpperCase();
            			}
HXLINE( 717)			this->skippedIntro = true;
            		}
            	}
...
{
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_401_boot)
HXDLIN( 401)		playJingle = false;
            	}
{
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_556_boot)
