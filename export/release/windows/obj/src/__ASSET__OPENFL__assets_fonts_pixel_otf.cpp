...
HX_DEFINE_STACK_FRAME(_hx_pos_f9bd248e8c37eaa1_529_new,"__ASSET__OPENFL__assets_fonts_pixel_otf","new",0xd7ddf5a3,"__ASSET__OPENFL__assets_fonts_pixel_otf.new","ManifestResources.hx",529,0xf77aa668)

void __ASSET__OPENFL__assets_fonts_pixel_otf_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_f9bd248e8c37eaa1_529_new)
HXDLIN( 529)		this->_hx___fromLimeFont( ::__ASSET__assets_fonts_pixel_otf_obj::__alloc( HX_CTX ));
HXDLIN( 529)		super::__construct(null());
            	}
