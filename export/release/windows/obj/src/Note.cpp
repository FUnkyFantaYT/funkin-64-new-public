...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_87_set_texture,"Note","set_texture",0x04eff9a2,"Note.set_texture","Note.hx",87,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_95_set_noteType,"Note","set_noteType",0x43779525,"Note.set_noteType","Note.hx",95,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_264_reloadNote,"Note","reloadNote",0x1599eec7,"Note.reloadNote","Note.hx",264,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_335_loadNoteAnims,"Note","loadNoteAnims",0x493f5f8e,"Note.loadNoteAnims","Note.hx",335,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_359_loadPixelNoteAnims,"Note","loadPixelNoteAnims",0xefd7042c,"Note.loadPixelNoteAnims","Note.hx",359,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_378_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",378,0x1a8855ec)
...
HXLINE( 263)		this->originalHeightForCalcs = ((Float)6);
HXLINE( 262)		this->lastNoteScaleToo = ((Float)1);
HXLINE( 261)		this->lastNoteOffsetXForPixelAutoAdjusting = ((Float)0);
HXLINE(  85)		this->addstuff = 0;
...
HXLINE( 152)		super::__construct(null(),null(),null());
HXLINE( 154)		if (::hx::IsNull( prevNote )) {
HXLINE( 155)			prevNote = ::hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 157)		this->prevNote = prevNote;
HXLINE( 158)		this->isSustainNote = ( (bool)(sustainNote) );
HXLINE( 159)		this->inEditor = ( (bool)(inEditor) );
HXLINE( 161)		int _hx_tmp;
HXDLIN( 161)		if (::ClientPrefs_obj::middleScroll) {
HXLINE( 161)			_hx_tmp = ::PlayState_obj::STRUM_X_MIDDLESCROLL;
            		}
            		else {
HXLINE( 161)			_hx_tmp = ::PlayState_obj::STRUM_X;
            		}
HXDLIN( 161)		this->set_x((this->x + (_hx_tmp + 50)));
HXLINE( 163)		this->set_y((this->y - ( (Float)(2000) )));
HXLINE( 164)		this->strumTime = strumTime;
HXLINE( 165)		if (!(( (bool)(inEditor) ))) {
HXLINE( 165)			 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 165)			_hx_tmp->strumTime = (_hx_tmp->strumTime + ::ClientPrefs_obj::noteOffset);
            		}
HXLINE( 167)		this->noteData = noteData;
HXLINE( 169)		if ((noteData > -1)) {
HXLINE( 170)			this->set_texture(HX_("",00,00,00,00));
HXLINE( 171)			this->colorSwap =  ::ColorSwap_obj::__alloc( HX_CTX );
HXLINE( 172)			this->shader = this->colorSwap->shader;
HXLINE( 174)			this->set_x((this->x + (::Note_obj::swagWidth * ( (Float)(::hx::Mod(noteData,4)) ))));
HXLINE( 175)			if (!(this->isSustainNote)) {
HXLINE( 176)				::String animToPlay = HX_("",00,00,00,00);
HXLINE( 177)				switch((int)(::hx::Mod(noteData,4))){
            					case (int)0: {
HXLINE( 180)						animToPlay = HX_("purple",3c,f6,89,71);
            					}
            					break;
            					case (int)1: {
HXLINE( 182)						animToPlay = HX_("blue",9a,42,19,41);
            					}
            					break;
            					case (int)2: {
HXLINE( 184)						animToPlay = HX_("green",c3,0e,ed,99);
            					}
            					break;
            					case (int)3: {
HXLINE( 186)						animToPlay = HX_("red",51,d9,56,00);
            					}
            					break;
            				}
HXLINE( 188)				this->animation->play((animToPlay + HX_("Scroll",2d,4c,f9,7b)),null(),null(),null());
            			}
            		}
HXLINE( 194)		bool _hx_tmp1;
HXDLIN( 194)		if (this->isSustainNote) {
HXLINE( 194)			_hx_tmp1 = ::hx::IsNotNull( prevNote );
            		}
            		else {
HXLINE( 194)			_hx_tmp1 = false;
            		}
HXDLIN( 194)		if (_hx_tmp1) {
HXLINE( 196)			this->set_alpha(((Float)0.6));
HXLINE( 197)			this->multAlpha = ((Float)0.6);
HXLINE( 198)			this->hitsoundDisabled = true;
HXLINE( 199)			if (::ClientPrefs_obj::downScroll) {
HXLINE( 199)				this->set_flipY(true);
            			}
HXLINE( 201)			 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 201)			Float _hx_tmp1 = _hx_tmp->offsetX;
HXDLIN( 201)			_hx_tmp->offsetX = (_hx_tmp1 + (this->get_width() / ( (Float)(2) )));
HXLINE( 202)			this->copyAngle = false;
HXLINE( 204)			switch((int)(noteData)){
            				case (int)0: {
HXLINE( 207)					this->animation->play(HX_("purpleholdend",40,d5,15,5b),null(),null(),null());
            				}
            				break;
            				case (int)1: {
HXLINE( 209)					this->animation->play(HX_("blueholdend",a2,f0,cd,25),null(),null(),null());
            				}
            				break;
            				case (int)2: {
HXLINE( 211)					this->animation->play(HX_("greenholdend",99,eb,5f,39),null(),null(),null());
            				}
            				break;
            				case (int)3: {
HXLINE( 213)					this->animation->play(HX_("redholdend",cb,ae,1e,ea),null(),null(),null());
            				}
            				break;
            			}
HXLINE( 216)			this->updateHitbox();
HXLINE( 218)			 ::Note _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 218)			Float _hx_tmp3 = _hx_tmp2->offsetX;
HXDLIN( 218)			_hx_tmp2->offsetX = (_hx_tmp3 - (this->get_width() / ( (Float)(2) )));
HXLINE( 220)			if (::PlayState_obj::isPixelStage) {
HXLINE( 221)				 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 221)				_hx_tmp->offsetX = (_hx_tmp->offsetX + 30);
            			}
HXLINE( 223)			if (prevNote->isSustainNote) {
HXLINE( 225)				switch((int)(prevNote->noteData)){
            					case (int)0: {
HXLINE( 228)						prevNote->animation->play(HX_("purplehold",7b,8d,da,cd),null(),null(),null());
            					}
            					break;
            					case (int)1: {
HXLINE( 230)						prevNote->animation->play(HX_("bluehold",d9,60,aa,a4),null(),null(),null());
            					}
            					break;
            					case (int)2: {
HXLINE( 232)						prevNote->animation->play(HX_("greenhold",82,f5,c1,bc),null(),null(),null());
            					}
            					break;
            					case (int)3: {
HXLINE( 234)						prevNote->animation->play(HX_("redhold",10,1f,bf,bf),null(),null(),null());
            					}
            					break;
            				}
HXLINE( 237)				 ::flixel::math::FlxPoint fh = prevNote->scale;
HXDLIN( 237)				fh->set_y((fh->y * ((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.05))));
HXLINE( 238)				if (::hx::IsNotNull( ::PlayState_obj::instance )) {
HXLINE( 240)					 ::flixel::math::FlxPoint fh = prevNote->scale;
HXDLIN( 240)					fh->set_y((fh->y * ::PlayState_obj::instance->songSpeed));
            				}
HXLINE( 243)				if (::PlayState_obj::isPixelStage) {
HXLINE( 244)					 ::flixel::math::FlxPoint fh = prevNote->scale;
HXDLIN( 244)					fh->set_y((fh->y * ((Float)1.19)));
HXLINE( 245)					 ::flixel::math::FlxPoint fh1 = prevNote->scale;
HXDLIN( 245)					Float fh2 = fh1->y;
HXDLIN( 245)					fh1->set_y((fh2 * (( (Float)(6) ) / this->get_height())));
            				}
HXLINE( 247)				prevNote->updateHitbox();
            			}
HXLINE( 251)			if (::PlayState_obj::isPixelStage) {
HXLINE( 252)				 ::flixel::math::FlxPoint fh = this->scale;
HXDLIN( 252)				fh->set_y((fh->y * ::PlayState_obj::daPixelZoom));
HXLINE( 253)				this->updateHitbox();
            			}
            		}
            		else {
HXLINE( 255)			if (!(this->isSustainNote)) {
HXLINE( 256)				this->earlyHitMult = ( (Float)(1) );
            			}
            		}
HXLINE( 258)		this->set_x((this->x + this->offsetX));
            	}
...
::String Note_obj::set_texture(::String value){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_87_set_texture)
HXLINE(  88)		if ((this->texture != value)) {
HXLINE(  89)			this->reloadNote(HX_("",00,00,00,00),value,null());
            		}
HXLINE(  91)		this->texture = value;
...
::String Note_obj::set_noteType(::String value){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_95_set_noteType)
HXLINE(  96)		this->noteSplashTexture = ( (::String)(::PlayState_obj::SONG->__Field(HX_("splashSkin",84,03,e1,a1),::hx::paccDynamic)) );
HXLINE(  97)		this->colorSwap->set_hue((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(this->noteData,4)).StaticCast< ::Array< int > >()->__get(0)) ) / ( (Float)(360) )));
HXLINE(  98)		this->colorSwap->set_saturation((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(this->noteData,4)).StaticCast< ::Array< int > >()->__get(1)) ) / ( (Float)(100) )));
HXLINE(  99)		this->colorSwap->set_brightness((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(this->noteData,4)).StaticCast< ::Array< int > >()->__get(2)) ) / ( (Float)(100) )));
HXLINE( 101)		bool _hx_tmp;
HXDLIN( 101)		if ((this->noteData > -1)) {
HXLINE( 101)			_hx_tmp = (this->noteType != value);
            		}
            		else {
HXLINE( 101)			_hx_tmp = false;
            		}
HXDLIN( 101)		if (_hx_tmp) {
HXLINE( 102)			::String _hx_switch_0 = value;
            			if (  (_hx_switch_0==HX_("Coin",b1,e1,9d,2c)) ){
HXLINE( 121)				this->reloadNote(HX_("",00,00,00,00),HX_("coin note",e1,24,a7,1f),null());
HXLINE( 122)				this->colorSwap->set_hue(( (Float)(0) ));
HXLINE( 123)				this->colorSwap->set_saturation(( (Float)(0) ));
HXLINE( 124)				this->colorSwap->set_brightness(( (Float)(0) ));
HXLINE( 125)				this->ignoreNote = true;
HXLINE( 126)				if ((::flixel::FlxG_obj::random->_hx_float(0,100,null()) < 1)) {
HXLINE( 128)					this->set_color(-11643219);
HXLINE( 129)					this->hitHealth = ( (Float)(6) );
            				}
            				else {
HXLINE( 131)					if ((::flixel::FlxG_obj::random->_hx_float(0,100,null()) < 10)) {
HXLINE( 133)						this->set_color(-4910080);
HXLINE( 134)						this->hitHealth = ( (Float)(2) );
            					}
            					else {
HXLINE( 138)						this->set_color(-5923072);
HXLINE( 139)						this->hitHealth = ( (Float)(1) );
            					}
            				}
HXLINE( 120)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("GF Sing",10,84,6e,29)) ){
HXLINE( 119)				this->gfNote = true;
HXDLIN( 119)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("Hurt Note",a3,41,9e,fe)) ){
HXLINE( 104)				this->ignoreNote = this->mustPress;
HXLINE( 105)				this->reloadNote(HX_("HURT",0f,24,d8,2f),null(),null());
HXLINE( 106)				this->noteSplashTexture = HX_("HURTnoteSplashes",36,d6,ee,48);
HXLINE( 107)				this->colorSwap->set_hue(( (Float)(0) ));
HXLINE( 108)				this->colorSwap->set_saturation(( (Float)(0) ));
HXLINE( 109)				this->colorSwap->set_brightness(( (Float)(0) ));
HXLINE( 110)				if (this->isSustainNote) {
HXLINE( 111)					this->missHealth = ((Float)0.1);
            				}
            				else {
HXLINE( 113)					this->missHealth = ((Float)0.3);
            				}
HXLINE( 115)				this->hitCausesMiss = true;
HXLINE( 103)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("No Animation",65,b2,1a,df)) ){
HXLINE( 117)				this->noAnimation = true;
HXDLIN( 117)				goto _hx_goto_2;
            			}
            			_hx_goto_2:;
HXLINE( 142)			this->noteType = value;
            		}
HXLINE( 144)		this->noteSplashHue = this->colorSwap->hue;
HXLINE( 145)		this->noteSplashSat = this->colorSwap->saturation;
HXLINE( 146)		this->noteSplashBrt = this->colorSwap->brightness;
...
void Note_obj::reloadNote(::String __o_prefix,::String __o_texture,::String __o_suffix){
            	...
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_264_reloadNote)
HXLINE( 265)		if (::hx::IsNull( prefix )) {
HXLINE( 265)			prefix = HX_("",00,00,00,00);
            		}
HXLINE( 266)		if (::hx::IsNull( texture )) {
HXLINE( 266)			texture = HX_("",00,00,00,00);
            		}
HXLINE( 267)		if (::hx::IsNull( suffix )) {
HXLINE( 267)			suffix = HX_("",00,00,00,00);
            		}
HXLINE( 269)		::String skin = texture;
HXLINE( 270)		if ((texture.length < 1)) {
HXLINE( 271)			skin = ( (::String)(::PlayState_obj::SONG->__Field(HX_("arrowSkin",e6,d4,f8,07),::hx::paccDynamic)) );
HXLINE( 272)			bool _hx_tmp;
HXDLIN( 272)			if (::hx::IsNotNull( skin )) {
HXLINE( 272)				_hx_tmp = (skin.length < 1);
            			}
            			else {
HXLINE( 272)				_hx_tmp = true;
            			}
HXDLIN( 272)			if (_hx_tmp) {
HXLINE( 273)				skin = HX_("NOTE_assets",70,3c,09,f7);
            			}
            		}
HXLINE( 277)		::String animName = null();
HXLINE( 278)		if (::hx::IsNotNull( this->animation->_curAnim )) {
HXLINE( 279)			animName = this->animation->_curAnim->name;
            		}
HXLINE( 282)		::Array< ::String > arraySkin = skin.split(HX_("/",2f,00,00,00));
HXLINE( 283)		arraySkin[(arraySkin->length - 1)] = ((prefix + arraySkin->__get((arraySkin->length - 1))) + suffix);
HXLINE( 285)		Float lastScaleY = this->scale->y;
HXLINE( 286)		::String blahblah = arraySkin->join(HX_("/",2f,00,00,00));
HXLINE( 287)		if (::PlayState_obj::isPixelStage) {
HXLINE( 288)			if (this->isSustainNote) {
HXLINE( 289)				::String library = null();
HXDLIN( 289)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(((HX_("pixelUI/",95,50,4f,7e) + blahblah) + HX_("ENDS",38,24,d7,2d)),library);
HXDLIN( 289)				this->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE( 290)				this->set_width((this->get_width() / ( (Float)(4) )));
HXLINE( 291)				this->set_height((this->get_height() / ( (Float)(2) )));
HXLINE( 292)				this->originalHeightForCalcs = this->get_height();
HXLINE( 293)				::String library1 = null();
HXDLIN( 293)				 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(((HX_("pixelUI/",95,50,4f,7e) + blahblah) + HX_("ENDS",38,24,d7,2d)),library1);
HXDLIN( 293)				int _hx_tmp = ::Math_obj::floor(this->get_width());
HXDLIN( 293)				this->loadGraphic(returnAsset1,true,_hx_tmp,::Math_obj::floor(this->get_height()),null(),null());
            			}
            			else {
HXLINE( 295)				::String library = null();
HXDLIN( 295)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic((HX_("pixelUI/",95,50,4f,7e) + blahblah),library);
HXDLIN( 295)				this->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE( 296)				this->set_width((this->get_width() / ( (Float)(4) )));
HXLINE( 297)				this->set_height((this->get_height() / ( (Float)(5) )));
HXLINE( 298)				::String library1 = null();
HXDLIN( 298)				 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic((HX_("pixelUI/",95,50,4f,7e) + blahblah),library1);
HXDLIN( 298)				int _hx_tmp = ::Math_obj::floor(this->get_width());
HXDLIN( 298)				this->loadGraphic(returnAsset1,true,_hx_tmp,::Math_obj::floor(this->get_height()),null(),null());
            			}
HXLINE( 300)			Float _hx_tmp = this->get_width();
HXDLIN( 300)			this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::PlayState_obj::daPixelZoom)),null());
HXLINE( 301)			this->loadPixelNoteAnims();
HXLINE( 302)			this->set_antialiasing(false);
HXLINE( 304)			if (this->isSustainNote) {
HXLINE( 305)				 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 305)				_hx_tmp->offsetX = (_hx_tmp->offsetX + this->lastNoteOffsetXForPixelAutoAdjusting);
HXLINE( 306)				Float _hx_tmp1 = (this->get_width() - ( (Float)(7) ));
HXDLIN( 306)				this->lastNoteOffsetXForPixelAutoAdjusting = (_hx_tmp1 * (::PlayState_obj::daPixelZoom / ( (Float)(2) )));
HXLINE( 307)				 ::Note _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 307)				_hx_tmp2->offsetX = (_hx_tmp2->offsetX - this->lastNoteOffsetXForPixelAutoAdjusting);
            			}
            		}
            		else {
HXLINE( 317)			::String library = null();
HXDLIN( 317)			 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(blahblah,null());
HXDLIN( 317)			bool xmlExists = false;
HXDLIN( 317)			if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 317)				xmlExists = true;
            			}
HXDLIN( 317)			 ::Dynamic _hx_tmp;
HXDLIN( 317)			if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 317)				_hx_tmp = imageLoaded;
            			}
            			else {
HXLINE( 317)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(blahblah,library);
HXDLIN( 317)				_hx_tmp = returnAsset;
            			}
HXDLIN( 317)			::String _hx_tmp1;
HXDLIN( 317)			if (xmlExists) {
HXLINE( 317)				_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE( 317)				_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            			}
HXDLIN( 317)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
HXLINE( 318)			this->loadNoteAnims();
HXLINE( 319)			this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            		}
HXLINE( 321)		if (this->isSustainNote) {
HXLINE( 322)			this->scale->set_y(lastScaleY);
            		}
HXLINE( 324)		this->updateHitbox();
HXLINE( 326)		if (::hx::IsNotNull( animName )) {
HXLINE( 327)			this->animation->play(animName,true,null(),null());
            		}
HXLINE( 329)		if (this->inEditor) {
HXLINE( 330)			this->setGraphicSize(::editors::ChartingState_obj::GRID_SIZE,::editors::ChartingState_obj::GRID_SIZE);
...
void Note_obj::loadNoteAnims(){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_335_loadNoteAnims)
HXLINE( 336)		this->animation->addByPrefix(HX_("greenScroll",30,4f,fe,9e),HX_("green0",0d,dc,7f,15),null(),null(),null(),null());
HXLINE( 337)		this->animation->addByPrefix(HX_("redScroll",3e,78,c3,3a),HX_("red0",bf,4d,a7,4b),null(),null(),null(),null());
HXLINE( 338)		this->animation->addByPrefix(HX_("blueScroll",47,7e,59,a2),HX_("blue0",56,04,01,b5),null(),null(),null(),null());
HXLINE( 339)		this->animation->addByPrefix(HX_("purpleScroll",69,97,67,99),HX_("purple0",74,7e,2d,e7),null(),null(),null(),null());
HXLINE( 341)		if (this->isSustainNote) {
HXLINE( 343)			this->animation->addByPrefix(HX_("purpleholdend",40,d5,15,5b),HX_("pruple end hold",6e,7c,17,3a),null(),null(),null(),null());
HXLINE( 344)			this->animation->addByPrefix(HX_("greenholdend",99,eb,5f,39),HX_("green hold end",77,4d,45,46),null(),null(),null(),null());
HXLINE( 345)			this->animation->addByPrefix(HX_("redholdend",cb,ae,1e,ea),HX_("red hold end",29,c1,a0,b6),null(),null(),null(),null());
HXLINE( 346)			this->animation->addByPrefix(HX_("blueholdend",a2,f0,cd,25),HX_("blue hold end",c0,66,05,ae),null(),null(),null(),null());
HXLINE( 348)			this->animation->addByPrefix(HX_("purplehold",7b,8d,da,cd),HX_("purple hold piece",b1,8b,b1,d3),null(),null(),null(),null());
HXLINE( 349)			this->animation->addByPrefix(HX_("greenhold",82,f5,c1,bc),HX_("green hold piece",8a,42,68,ae),null(),null(),null(),null());
HXLINE( 350)			this->animation->addByPrefix(HX_("redhold",10,1f,bf,bf),HX_("red hold piece",bc,86,4d,83),null(),null(),null(),null());
HXLINE( 351)			this->animation->addByPrefix(HX_("bluehold",d9,60,aa,a4),HX_("blue hold piece",13,00,58,99),null(),null(),null(),null());
            		}
HXLINE( 354)		this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ((Float)0.7))),null());
...
void Note_obj::loadPixelNoteAnims(){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_359_loadPixelNoteAnims)
HXDLIN( 359)		if (this->isSustainNote) {
HXLINE( 360)			this->animation->add(HX_("purpleholdend",40,d5,15,5b),::Array_obj< int >::__new(1)->init(0,(::Note_obj::PURP_NOTE + 4)),null(),null(),null(),null());
HXLINE( 361)			this->animation->add(HX_("greenholdend",99,eb,5f,39),::Array_obj< int >::__new(1)->init(0,(::Note_obj::GREEN_NOTE + 4)),null(),null(),null(),null());
HXLINE( 362)			this->animation->add(HX_("redholdend",cb,ae,1e,ea),::Array_obj< int >::__new(1)->init(0,(::Note_obj::RED_NOTE + 4)),null(),null(),null(),null());
HXLINE( 363)			this->animation->add(HX_("blueholdend",a2,f0,cd,25),::Array_obj< int >::__new(1)->init(0,(::Note_obj::BLUE_NOTE + 4)),null(),null(),null(),null());
HXLINE( 365)			this->animation->add(HX_("purplehold",7b,8d,da,cd),::Array_obj< int >::__new(1)->init(0,::Note_obj::PURP_NOTE),null(),null(),null(),null());
HXLINE( 366)			this->animation->add(HX_("greenhold",82,f5,c1,bc),::Array_obj< int >::__new(1)->init(0,::Note_obj::GREEN_NOTE),null(),null(),null(),null());
HXLINE( 367)			this->animation->add(HX_("redhold",10,1f,bf,bf),::Array_obj< int >::__new(1)->init(0,::Note_obj::RED_NOTE),null(),null(),null(),null());
HXLINE( 368)			this->animation->add(HX_("bluehold",d9,60,aa,a4),::Array_obj< int >::__new(1)->init(0,::Note_obj::BLUE_NOTE),null(),null(),null(),null());
            		}
            		else {
HXLINE( 370)			this->animation->add(HX_("greenScroll",30,4f,fe,9e),::Array_obj< int >::__new(1)->init(0,(::Note_obj::GREEN_NOTE + 4)),null(),null(),null(),null());
HXLINE( 371)			this->animation->add(HX_("redScroll",3e,78,c3,3a),::Array_obj< int >::__new(1)->init(0,(::Note_obj::RED_NOTE + 4)),null(),null(),null(),null());
HXLINE( 372)			this->animation->add(HX_("blueScroll",47,7e,59,a2),::Array_obj< int >::__new(1)->init(0,(::Note_obj::BLUE_NOTE + 4)),null(),null(),null(),null());
HXLINE( 373)			this->animation->add(HX_("purpleScroll",69,97,67,99),::Array_obj< int >::__new(1)->init(0,(::Note_obj::PURP_NOTE + 4)),null(),null(),null(),null());
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_378_update)
HXLINE( 379)		this->super::update(elapsed);
HXLINE( 381)		if (this->mustPress) {
HXLINE( 384)			bool _hx_tmp;
HXDLIN( 384)			if ((this->strumTime > (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 384)				_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * this->earlyHitMult)));
            			}
            			else {
HXLINE( 384)				_hx_tmp = false;
            			}
HXDLIN( 384)			if (_hx_tmp) {
HXLINE( 386)				this->canBeHit = true;
            			}
            			else {
HXLINE( 388)				this->canBeHit = false;
            			}
HXLINE( 390)			bool _hx_tmp1;
HXDLIN( 390)			if ((this->strumTime < (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 390)				_hx_tmp1 = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 390)				_hx_tmp1 = false;
            			}
HXDLIN( 390)			if (_hx_tmp1) {
HXLINE( 391)				this->tooLate = true;
            			}
            		}
            		else {
HXLINE( 395)			this->canBeHit = false;
HXLINE( 397)			if ((this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * this->earlyHitMult)))) {
HXLINE( 399)				bool _hx_tmp;
HXDLIN( 399)				bool _hx_tmp1;
HXDLIN( 399)				if (this->isSustainNote) {
HXLINE( 399)					_hx_tmp1 = this->prevNote->wasGoodHit;
            				}
            				else {
HXLINE( 399)					_hx_tmp1 = false;
            				}
HXDLIN( 399)				if (!(_hx_tmp1)) {
HXLINE( 399)					_hx_tmp = (this->strumTime <= ::Conductor_obj::songPosition);
            				}
            				else {
HXLINE( 399)					_hx_tmp = true;
            				}
HXDLIN( 399)				if (_hx_tmp) {
HXLINE( 400)					this->wasGoodHit = true;
            				}
            			}
            		}
HXLINE( 404)		bool _hx_tmp;
HXDLIN( 404)		if (this->tooLate) {
HXLINE( 404)			_hx_tmp = !(this->inEditor);
            		}
            		else {
HXLINE( 404)			_hx_tmp = false;
            		}
HXDLIN( 404)		if (_hx_tmp) {
HXLINE( 406)			if ((this->alpha > ((Float)0.3))) {
HXLINE( 407)				this->set_alpha(((Float)0.3));
            			}
            		}
            	}
...
void Note_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(addstuff,"addstuff");
...
void Note_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(addstuff,"addstuff");
...
::hx::Val Note_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"addstuff") ) { return ::hx::Val( addstuff ); }
		break;
	case 9:
...
::hx::Val Note_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"addstuff") ) { addstuff=inValue.Cast< int >(); return inValue; }
		break;
	case 9:
...
void Note_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("addstuff",33,4d,4a,6a));
...
static ::hx::StorageInfo Note_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsInt,(int)offsetof(Note_obj,addstuff),HX_("addstuff",33,4d,4a,6a)},
