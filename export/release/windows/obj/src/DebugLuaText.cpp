...
HX_DEFINE_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_2074_new,"DebugLuaText","new",0xad824284,"DebugLuaText.new","FunkinLua.hx",2074,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_2086_update,"DebugLuaText","update",0x3cb60265,"DebugLuaText.update","FunkinLua.hx",2086,0x00117937)

void DebugLuaText_obj::__construct(::String text, ::flixel::group::FlxTypedGroup parentGroup){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_2074_new)
HXLINE(2076)		this->disableTime = ((Float)6);
HXLINE(2079)		this->parentGroup = parentGroup;
HXLINE(2080)		super::__construct(10,10,0,text,16,null());
HXLINE(2081)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(2081)		::String _hx_tmp;
HXDLIN(2081)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(2081)			_hx_tmp = file;
            		}
            		else {
HXLINE(2081)			_hx_tmp = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(2081)		this->setFormat(_hx_tmp,20,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(2082)		this->scrollFactor->set(null(),null());
HXLINE(2083)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_2086_update)
HXLINE(2087)		this->super::update(elapsed);
HXLINE(2088)		 ::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(2088)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(2089)		if ((this->disableTime <= 0)) {
HXLINE(2090)			this->kill();
HXLINE(2091)			this->parentGroup->remove(::hx::ObjectPtr<OBJ_>(this),null()).StaticCast<  ::DebugLuaText >();
HXLINE(2092)			this->destroy();
            		}
            		else {
HXLINE(2094)			if ((this->disableTime < 1)) {
HXLINE(2094)				this->set_alpha(this->disableTime);
            			}
            		}
            	}
