...
HX_DEFINE_STACK_FRAME(_hx_pos_552a6f94cb341f6a_2061_new,"ModchartText","new",0x58e3633b,"ModchartText.new","FunkinLua.hx",2061,0x00117937)

void ModchartText_obj::__construct(Float x,Float y,::String text,Float width){
            	HX_STACKFRAME(&_hx_pos_552a6f94cb341f6a_2061_new)
HXLINE(2063)		this->wasAdded = false;
HXLINE(2066)		super::__construct(x,y,width,text,16,null());
HXLINE(2067)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(2067)		::String _hx_tmp;
HXDLIN(2067)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(2067)			_hx_tmp = file;
            		}
            		else {
HXLINE(2067)			_hx_tmp = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(2067)		this->setFormat(_hx_tmp,16,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(2068)		this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::PlayState_obj::instance->camHUD));
HXLINE(2069)		this->scrollFactor->set(null(),null());
HXLINE(2070)		this->set_borderSize(( (Float)(2) ));
            	}
