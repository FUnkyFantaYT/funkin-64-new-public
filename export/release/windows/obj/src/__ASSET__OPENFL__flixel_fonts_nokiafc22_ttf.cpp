...
HX_DEFINE_STACK_FRAME(_hx_pos_78712a569baebf83_531_new,"__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf","new",0xcba1a9da,"__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf.new","ManifestResources.hx",531,0xf77aa668)

void __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_78712a569baebf83_531_new)
HXDLIN( 531)		this->_hx___fromLimeFont( ::__ASSET__flixel_fonts_nokiafc22_ttf_obj::__alloc( HX_CTX ));
HXDLIN( 531)		super::__construct(null());
            	}
