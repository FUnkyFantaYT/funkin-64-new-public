...
HXLINE(  26)		this->warnText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,::flixel::FlxG_obj::width,((((HX_("Sup bro, looks like you're running an   \n\r\n\t\t\toutdated version of Psych Engine (",c3,4b,83,4f) + ::MainMenuState_obj::psychEngineVersion) + HX_("),\n\r\n\t\t\tplease update to ",bf,56,e0,06)) + ::TitleState_obj::updateVersion) + HX_("!\n\r\n\t\t\tPress ESCAPE to proceed anyway.\n\r\n\t\t\t\n\r\n\t\t\tThank you for using the Engine!",cf,10,a0,8f)),32,null());
HXLINE(  34)		this->warnText->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),32,-1,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE(  35)		this->warnText->screenCenter(::flixel::util::FlxAxes_obj::Y_dyn());
