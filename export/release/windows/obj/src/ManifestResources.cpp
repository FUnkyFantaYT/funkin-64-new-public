...
HXLINE(  75)		{
HXLINE(  75)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  75)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v2);
            		}
...
HXLINE(  80)			::ManifestResources_obj::preloadLibraryNames->push(HX_("songs",fe,36,c7,80));
            		}
HXLINE(  81)		library = ::lime::utils::Assets_obj::getLibrary(HX_("shared",a5,5e,2b,1d));
HXLINE(  82)		if (::hx::IsNotNull( library )) {
HXLINE(  82)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  83)			::ManifestResources_obj::preloadLibraryNames->push(HX_("shared",a5,5e,2b,1d));
            		}
HXLINE(  84)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  85)		if (::hx::IsNotNull( library )) {
HXLINE(  85)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  86)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
