...
HX_DEFINE_STACK_FRAME(_hx_pos_d4db2ac25d8e506a_2820_new,"editors.AttachedFlxText","new",0x7b9cbf45,"editors.AttachedFlxText.new","editors/ChartingState.hx",2820,0x5a24859a)
HX_LOCAL_STACK_FRAME(_hx_pos_d4db2ac25d8e506a_2831_update,"editors.AttachedFlxText","update",0x30e33444,"editors.AttachedFlxText.update","editors/ChartingState.hx",2831,0x5a24859a)
namespace editors{
...
void AttachedFlxText_obj::__construct(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y,::hx::Null< Float >  __o_FieldWidth,::String Text,::hx::Null< int >  __o_Size,::hx::Null< bool >  __o_EmbeddedFont){
            	...
            	HX_STACKFRAME(&_hx_pos_d4db2ac25d8e506a_2820_new)
HXLINE(2824)		this->yAdd = ((Float)0);
HXLINE(2823)		this->xAdd = ((Float)0);
HXLINE(2827)		super::__construct(X,Y,FieldWidth,Text,Size,EmbeddedFont);
            	}
...
void AttachedFlxText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_d4db2ac25d8e506a_2831_update)
HXLINE(2832)		this->super::update(elapsed);
HXLINE(2834)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE(2835)			this->setPosition((this->sprTracker->x + this->xAdd),(this->sprTracker->y + this->yAdd));
HXLINE(2836)			this->set_angle(this->sprTracker->angle);
HXLINE(2837)			this->set_alpha(this->sprTracker->alpha);
            		}
            	}
