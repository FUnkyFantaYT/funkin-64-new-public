...
HX_DEFINE_STACK_FRAME(_hx_pos_aa3eaf4dd720a73e_532_new,"__ASSET__OPENFL__flixel_fonts_monsterrat_ttf","new",0x4d419742,"__ASSET__OPENFL__flixel_fonts_monsterrat_ttf.new","ManifestResources.hx",532,0xf77aa668)

void __ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_aa3eaf4dd720a73e_532_new)
HXDLIN( 532)		this->_hx___fromLimeFont( ::__ASSET__flixel_fonts_monsterrat_ttf_obj::__alloc( HX_CTX ));
HXDLIN( 532)		super::__construct(null());
            	}
