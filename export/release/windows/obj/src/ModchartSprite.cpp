...
HX_DEFINE_STACK_FRAME(_hx_pos_2b7f7cc83b4d0792_2049_new,"ModchartSprite","new",0xbc67fd93,"ModchartSprite.new","FunkinLua.hx",2049,0x00117937)
...
void ModchartSprite_obj::__construct( ::Dynamic __o_x, ::Dynamic __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_2b7f7cc83b4d0792_2049_new)
HXLINE(2051)		this->wasAdded = false;
HXLINE(2056)		super::__construct(x,y,null());
HXLINE(2057)		this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            	}
